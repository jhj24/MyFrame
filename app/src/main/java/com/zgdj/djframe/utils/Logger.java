...
public class Logger {
    ...
    // 打印标签
    private static String logtag = "Logger";
    ...
    public static void w(String text) {
        if (isLogger) {
            Log.w(logtag, logContent(text) + logLocation(0));
        }
    }

    public static void w(String text, int index) {
        if (isLogger) {
            Log.w(logtag, logContent(text) + logLocation(index));
        }
    }
