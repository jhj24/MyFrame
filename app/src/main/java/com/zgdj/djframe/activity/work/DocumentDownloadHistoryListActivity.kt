...
import com.zgdj.djframe.adapter.DocumentDownloadHistoryListAdapter
...
import kotlinx.android.synthetic.main.activity_document_download_history_list.*
import kotlinx.android.synthetic.main.layout_empty.*
import org.xutils.common.Callback
import org.xutils.http.RequestParams
import org.xutils.x

class DocumentDownloadHistoryListActivity : BaseNormalActivity() {


    private lateinit var listDialog: ListViewDialog
    private lateinit var loadingDialog: LoadingDialog //loading dialog
    private lateinit var footerView: View
    private lateinit var adapter: DocumentDownloadHistoryListAdapter
    private lateinit var list: MutableList<DocumentDownloadHistroyModel.DataBean>
    ...
    override fun bindLayout(): Int {
        return R.layout.activity_document_download_history_list
    }
    ...
    override fun initView(savedInstanceState: Bundle?, view: View?) {
        ...
        adapter = DocumentDownloadHistoryListAdapter(list, R.layout.item_recycler_document_download_history)
    ...
    private fun getListInfoTask(search: String = "") {
        ...
        val params = RequestParams(Constant.URL_WORK_DOCUMENT_DOWNLOAD_HISTORY)
        ...
        x.http().post(params, object : Callback.CommonCallback<String> {
            ...
            override fun onSuccess(result: String?) {
                ...
                val model = Gson().fromJson(result, DocumentDownloadHistroyModel::class.java)
                if (model.code != 1) {
                    if (model.code == -2) {
