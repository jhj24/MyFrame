package com.zgdj.djframe.view.treeview;
...
public abstract class TreeViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public TreeViewAdapter(List<? extends TreeViewBinder> viewBinders, Context context) {
        this(null, viewBinders, context);
    }

    public TreeViewAdapter(List<TreeNode> list, List<? extends TreeViewBinder> viewBinders, Context context) {
        this.viewBinders = viewBinders;
        this.originList = list;
        this.context = context;
        padding = Utils.dp2px(context, 16);
        if (list != null) {
