...
public class ScrollManager {
    ...
    public ScrollManager(GalleryRecyclerView mGalleryRecyclerView, Context context) {
    ...
    public void updateComsume() {
        mConsumeX += Utils.dp2px(context, GalleryItemDecoration.mLeftPageVisibleWidth + GalleryItemDecoration.mPageMargin * 2);
        mConsumeY += Utils.dp2px(context, GalleryItemDecoration.mLeftPageVisibleWidth + GalleryItemDecoration.mPageMargin * 2);
